...
INSERT INTO pedido (id,fecha_pedido, fecha_esperada, fecha_entrega, estado_pedido_id, cliente_id, pago_id, comentarios)
VALUES
(1, '2006-01-17', '2006-01-19', '2006-01-19', 1, 5, 'Pagado a plazos'),
(2, '2007-10-23', '2007-10-28', '2007-10-26', 1, 5, 'La entrega llegó antes de lo esperado'),
(3, '2008-06-20', '2008-06-25', NULL, 2, 5, 'Límite de crédito superado'),
(4, '2009-01-20', '2009-01-26', NULL, 3, NULL, 'Pendiente'),
...
(10, '2009-01-15', '2009-01-20', NULL, 3, NULL, 'El cliente llama para confirmar la fecha - Esperando al proveedor'),
(11, '2009-01-20', '2009-01-27', NULL, 1, NULL, 'El cliente requiere que el pedido se le entregue de 16:00h a 22:00h'),
(12, '2009-01-22', '2009-01-27', NULL, 1, NULL, 'El cliente requiere que el pedido se le entregue de 9:00h a 13:00h'),
(13, '2009-01-12', '2009-01-14', '2009-01-15', 1, NULL, NULL),
(14, '2009-01-02', '2009-01-02', NULL, 2, NULL, 'Mal pago'),
(15, '2009-01-09', '2009-01-12', '2009-01-11', 1, NULL, NULL),
(16, '2009-01-06', '2009-01-07', '2009-01-15', 1, NULL, NULL),
(17, '2009-01-08', '2009-01-09', '2009-01-11', 1, NULL, 'Mal estado'),
(18, '2009-01-05', '2009-01-06', '2009-01-07', 1, NULL, NULL),
(19, '2009-01-18', '2009-02-12', NULL, 2, NULL, 'Entregar en Murcia'),
(20, '2009-01-20', '2009-02-15', NULL, 2, NULL, NULL),
(21, '2009-01-09', '2009-01-09', '2009-01-09', 2, 9, 18, 'Mal pago'),
(22, '2009-01-11', '2009-01-11', '2009-01-13', 1, 1, 19, NULL),
(23, '2008-12-30', '2009-01-10', NULL, 2, 2, 5, 'El pedido fue anulado por el cliente'),
(24, '2008-07-14', '2008-07-31', '2008-07-25', 1, 1, 20, NULL),
(25, '2009-02-02', '2009-02-08', NULL, 2, 3, 21, 'El cliente carece de saldo en la cuenta asociada'),
(26, '2009-02-06', '2009-02-12', NULL, 2, 4, 22, 'El cliente anula la operación para adquirir más producto'),
(27, '2009-02-07', '2009-02-13', NULL, 1, 4, 1, 'El pedido aparece como entregado pero no sabemos en qué fecha'),
(28, '2009-02-10', '2009-02-17', '2009-02-20', 1, 4, 2, 'El cliente se queja bastante de la espera asociada al producto'),
(29, '2008-08-01', '2008-09-01', '2008-09-01', 2, 6, 23, 'El cliente no está conforme con el pedido'),
(30, '2008-08-03', '2008-09-03', '2008-08-31', 1, 5, 24, NULL),
(31, '2008-09-04', '2008-09-30', '2008-10-04', 2, 5, 25, 'El cliente ha rechazado por llegar 5 días tarde'),
(32, '2007-01-07', '2007-01-19', '2007-01-27', 1, 3, 26, 'Entrega tardía, el cliente puso reclamación'),
(33, '2007-05-20', '2007-05-28', NULL, 2, 3, 27, 'El pedido fue anulado por el cliente'),
(34, '2007-06-20', '2008-06-28', '2008-06-28', 1, 3, 28, 'Pagado a plazos'),
(35, '2008-03-10', '2009-03-20', NULL, 2, 3, 29, 'Límite de crédito superado'),
(36, '2008-10-15', '2008-12-15', '2008-12-10', 1, 1, 20, NULL),
(37, '2008-11-03', '2009-11-13', NULL, 3, 2, 30, 'El pedido nunca llegó a su destino'),
(38, '2009-03-05', '2009-03-06', '2009-03-07', 1, 5, 31, NULL),
(39, '2009-03-06', '2009-03-07', '2009-03-09', 3, 5, 32, NULL),
(40, '2009-03-09', '2009-03-10', '2009-03-13', 2, 5, 33, NULL),
(41, '2009-03-12', '2009-03-13', '2009-03-13', 1, 5, 34, NULL),
(42, '2009-03-22', '2009-03-23', '2009-03-27', 1, 5, 35, NULL),
(43, '2009-03-25', '2009-03-26', '2009-03-28', 3, 7, 36, NULL),
(44, '2009-03-26', '2009-03-27', '2009-03-30', 3, 7, 37, NULL),
(45, '2009-04-01', '2009-03-04', '2009-03-07', 1, 7, 38, NULL),
(46, '2009-04-03', '2009-03-04', '2009-03-05', 2, 7, 39, NULL),
(47, '2009-04-15', '2009-03-17', '2009-03-17', 1, 7, 40, NULL),
(48, '2008-03-17', '2008-03-30', '2008-03-29', 1, 8, 41, 'Según el Cliente, el pedido llegó defectuoso'),
(49, '2008-07-12', '2008-07-22', '2008-07-30', 1, 8, 42, 'El pedido llegó 1 día tarde, pero no hubo queja por parte de la empresa compradora'),
(50, '2008-03-17', '2008-08-09', NULL, 3, 8, 43, 'Al parecer, el pedido se ha extraviado a la altura de Sotalbo (Ávila)'),
(51, '2008-10-01', '2008-10-14', '2008-10-14', 1, 8, 44, 'Todo se entregó a tiempo y en perfecto estado, a pesar del pésimo estado de las carreteras.'),
(52, '2008-12-07', '2008-12-21', NULL, 3, 8, 45, 'El transportista ha llamado a Eva María para indicarle que el pedido llegará más tarde de lo esperado.'),
(53, '2008-10-15', '2008-11-15', '2008-11-09', 1, 5, 46, 'El pedido llega 6 días antes'),
(54, '2009-01-11', '2009-02-11', NULL, 3, 5, 47, NULL),
(55, '2008-12-10', '2009-01-10', '2009-01-11', 1, 6, 48, 'Retrasado 1 día por problemas de transporte'),
(56, '2008-12-19', '2009-01-20', NULL, 2, 5, 49, 'El cliente ha anulado el pedido el día 2009-01-10'),
(57, '2009-01-05', '2009-02-05', NULL, 3, 5, 50, NULL),
(58, '2009-01-24', '2009-01-31', '2009-01-30', 1, 7, 51, 'Todo correcto'),
(59, '2008-11-09', '2008-11-14', '2008-11-14', 1, 1, 20, 'El cliente paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas'),
(60, '2008-12-22', '2008-12-27', '2008-12-28', 1, 1, 52, 'El cliente comprueba la integridad del paquete, todo correcto'),
(61, '2009-01-15', '2009-01-20', NULL, 3, 1, 53, 'El cliente llama para confirmar la fecha - Esperando al proveedor'),
(62, '2009-01-20', '2009-01-27', NULL, 1, 1, 54, 'El cliente requiere que el pedido se le entregue de 16:00h a 22:00h'),
(63, '2009-01-22', '2009-01-27', NULL, 1, 1, 55, 'El cliente requiere que el pedido se le entregue de 9:00h a 13:00h'),
(64, '2009-01-24', '2009-01-31', '2009-01-30', 1, 1, 51, 'Todo correcto'),
(65, '2009-02-02', '2009-02-08', NULL, 1, 1, 21, 'El cliente carece de saldo en la cuenta asociada'),
(66, '2009-02-06', '2009-02-12', NULL, 3, 1, 22, 'El cliente anula la operación para adquirir más producto'),
(67, '2009-02-07', '2009-02-13', NULL, 3, 1, 1, 'El pedido aparece como entregado pero no sabemos en qué fecha'),
(68, '2009-02-10', '2009-02-17', '2009-02-20', 1, 3, 2, 'El cliente se queja bastante de la espera asociada al producto'),
(74, '2009-01-14', '2009-01-22', NULL, 3, 4, 56, 'El pedido no llegó el día que quería el cliente por fallo del transporte'),
(75, '2009-01-11', '2009-01-13', '2009-01-13', 1, 4, 57, 'El pedido llegó perfectamente'),
(76, '2008-11-15', '2008-11-23', '2008-11-23', 1, 4, 58, NULL),
(77, '2009-01-03', '2009-01-08', NULL, 3, 4, 59, 'El pedido no pudo ser entregado por problemas meteorológicos'),
(78, '2008-12-15', '2008-12-17', '2008-12-17', 1, 4, 60, 'Fue entregado, pero faltaba mercancía que será entregada otro día'),
(79, '2009-01-12', '2009-01-13', '2009-01-13', 1, 5, 61, NULL),
(80, '2009-01-25', '2009-01-26', NULL, 3, 5, 62, 'No terminó el pago'),
(81, '2009-01-18', '2009-01-24', NULL, 2, 5, 63, 'Los productos estaban en mal estado'),
(82, '2009-01-20', '2009-01-29', '2009-01-29', 1, 5, 64, 'El pedido llegó un poco más tarde de la hora fijada'),
(83, '2009-01-24', '2009-01-28', NULL, 1, 5, 65, NULL),
(89, '2007-10-05', '2007-12-13', '2007-12-10', 1, 35, 66, 'La entrega se realizó días antes de la fecha esperada por lo que el cliente quedó satisfecho'),
(90, '2009-02-07', '2008-02-17', NULL, 3, 27, 67, 'Debido a la nevada caída en la sierra, el pedido no podrá llegar hasta el día '),
(91, '2009-03-18', '2009-03-29', '2009-03-27', 1, 27, 68, 'Todo se entregó a su debido tiempo, incluso con un día de antelación'),
(92, '2009-04-19', '2009-04-30', '2009-05-03', 1, 27, 69, 'El pedido se entregó tarde debido a la festividad celebrada en España durante esas fechas'),
(93, '2009-05-03', '2009-05-30', '2009-05-17', 1, 27, 70, 'El pedido se entregó antes de lo esperado.'),
(94, '2009-10-18', '2009-11-01', NULL, 3, 27, 71, 'El pedido está en camino.'),
(95, '2008-01-04', '2008-01-19', '2008-01-19', 1, 35, NULL),
(96, '2008-03-20', '2008-04-12', '2008-04-13', 1, 35, 72, 'La entrega se retrasó un día'),
...
(100, '2009-01-10', '2009-01-15', '2009-01-15', 1, 16, 73, 'El pedido llegó perfectamente'),
(101, '2009-03-07', '2009-03-27', NULL, 2, 16, 74, 'El pedido fue rechazado por el cliente'),
(102, '2008-12-28', '2009-01-08', '2009-01-08', 1, 16, 75, 'Pago pendiente'),
(103, '2009-01-15', '2009-01-20', '2009-01-24', 2, 30, NULL),
(104, '2009-03-02', '2009-03-06', '2009-03-06', 1, 30, NULL),
(105, '2009-02-14', '2009-02-20', NULL, 2, 30, 76, 'El producto ha sido rechazado por la pésima calidad'),
(106, '2009-05-13', '2009-05-15', '2009-05-20', 2, 30, NULL),
...
(113, '2008-10-28', '2008-11-09', '2009-01-09', 2, 36, 77, 'El producto ha sido rechazado por la tardanza de el envío'),
(114, '2009-01-15', '2009-01-29', '2009-01-31', 1, 36, 78, 'El envío llegó dos días más tarde debido al mal tiempo'),
(115, '2008-11-29', '2009-01-26', '2009-02-27', 3, 36, NULL),
(116, '2008-06-28', '2008-08-01', '2008-08-01', 1, 38, NULL),
(117, '2008-08-25', '2008-10-01', NULL, 2, 38, 79, 'El pedido ha sido rechazado por la acumulación de pagos pendientes del cliente'),
(118, '2009-02-15', '2009-02-27', NULL, 3, 16, NULL),
(119, '2009-01-10', '2009-01-15', '2009-01-15', 1, 16, 73, 'El pedido llegó perfectamente'),
(120, '2009-03-07', '2009-03-27', NULL, 2, 16, 74, 'El pedido fue rechazado por el cliente'),
(121, '2008-12-28', '2009-01-08', '2009-01-08', 1, 16, 75, 'Pago pendiente'),
(122,'2009-04-09','2009-04-15','2009-04-15', 1, NULL, 16),
(123,'2009-01-15','2009-01-20','2009-01-24', 2, NULL, 80),
(124,'2009-03-02','2009-03-06','2009-03-06', 1, NULL, 81),
(125,'2009-02-14','2009-02-20', NULL, 2, 30, 'El producto ha sido rechazado por la pésima calidad'),
(126,'2009-05-13','2009-05-15','2009-05-20', 2, NULL, 82),
(127,'2009-04-06','2009-04-10','2009-04-10', 1, NULL, 83),
